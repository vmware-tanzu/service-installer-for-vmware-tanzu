...
1. Install Tanzu Kubernetes Grid.
    ...
    **Note:** 
    1. Once you extract the TAR file downloaded as part of [Deployment Steps](#deployment-steps), make sure that you are in `<your_directory>/deployment_binaries/sivt-aws-federal/` folder while running `make` commands.
