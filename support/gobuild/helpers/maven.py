...
class MavenHelper:
    ...
    """
    def _Command(self, hosttype, targets, mavenversion='3.5.0',
                 mavenoptions={}, **systemproperties):
        """
        ...
        if hosttype.startswith('windows'):
            ...
            mavencmd = ('%s/noarch/apache-maven-%s/bin/mvn.bat' %
                        (tcroot, mavenversion))
        else:
            mavencmd = ('/build/toolchain/noarch/apache-maven-%s/bin/mvn' %
                        mavenversion)
