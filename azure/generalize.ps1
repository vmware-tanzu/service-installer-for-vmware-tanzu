...
Remove-Item -Path .\1_netsec\provider.tf | Out-Null
Remove-Item -Recurse -Path .\1_netsec\.terraform -Force
Remove-Item -Path .\2_dns\.terraform.lock.hcl
Remove-Item -Path .\2_dns\provider.tf | Out-Null
Remove-Item -Recurse -Path .\2_dns\.terraform -Force
Remove-Item -Path .\3_bootstrap\.terraform.lock.hcl
Remove-Item -Path .\3_bootstrap\data.tf | Out-Null
Remove-Item -Path .\3_bootstrap\provider.tf | Out-Null
Remove-Item -Recurse -Path .\3_bootstrap\.terraform -Force
Remove-Item -Recurse -Path .\3_bootstrap\bootstrap.pem | Out-Null
