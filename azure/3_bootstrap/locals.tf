...
locals {
  ...
  netsec_resource_group     = var.netsec_resource_group != "" ? var.netsec_resource_group : data.azurerm_key_vault_secret.this["AZURE-VNET-RESOURCE-GROUP"].value
  netsec_vnet               = var.vnet_name != "" ? var.vnet_name : data.azurerm_key_vault_secret.this["AZURE-VNET-NAME"].value
  ...
  cloud_yaml = {
    "AZURE-CLIENT-ID"                            = module.app_reg.AZURE_CLIENT_ID
    "AZURE-CLIENT-SECRET"                        = module.app_reg.AZURE_CLIENT_SECRET
    ...
    "CLUSTER-NAME-management"                    = data.azurerm_key_vault_secret.this["CLUSTER-NAME-management"].value
    "CLUSTER-NAME-workload"                      = data.azurerm_key_vault_secret.this["CLUSTER-NAME-workload"].value
