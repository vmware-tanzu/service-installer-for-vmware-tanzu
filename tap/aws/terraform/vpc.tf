...
resource "aws_vpc" "main" {
  ...
  tags = {
    ...
    "kubernetes.io/cluster/${var.project}-run" = "shared"
    "kubernetes.io/cluster/${var.project}-view" = "shared"
    "kubernetes.io/cluster/${var.project}-build" = "shared"
    "kubernetes.io/cluster/${var.project}-iterate" = "shared"
  }
}
