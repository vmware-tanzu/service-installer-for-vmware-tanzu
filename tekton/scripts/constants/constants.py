...
class KubernetesOva:
    ...
    TKG_SUPPORTED_VERSIONS = ["1.5.3", "1.5.4", "1.6.0"]
    tkg_version = ""
    tkg_type = ""
    ...
    if tkg_type == "tkgm" and tkg_version not in TKG_SUPPORTED_VERSIONS:
        raise f"TKGm Version is not in supported list"

    try:
        kubernetes_ova_dict = {"1.5.3": {
                    ...
                    "UBUNTU_KUBERNETES_TEMPLATE_FILE_NAME": "ubuntu-2004-kube-v1.22.8+vmware.1",
                    ...
                    "1.5.4": {
                        ...
                        "UBUNTU_KUBERNETES_TEMPLATE_FILE_NAME": "ubuntu-2004-kube-v1.22.9+vmware.1",
                        "MARKETPLACE_KUBERNETES_SOLUTION_NAME": "tanzu-kubernetes-grid-1-1",
                        "MARKETPLACE_UBUNTU_KUBERNETES_FILE_NAME": "arcas-ubuntu-kube",
                        "MARKETPLACE_PHOTON_KUBERNETES_FILE_NAME": "arcas-photon-kube",
                        "MARKETPLACE_PHOTON_GROUPNAME": "Photon-OVA",
                    ...
                    "1.6.0": {
                        "UBUNTU_KUBERNETES_FILE_NAME": "ubuntu-2004-kube-v1.23.8-vmware.2-tkg.1-85a434f93857371fccb566a414462981.ova",
                        "PHOTON_KUBERNETES_FILE_NAME": "photon-3-kube-v1.23.8-vmware.2-tkg.2-81d1a7892ad39f017fbaf59f9907cbe7--1-.ova",
                        "PHOTON_KUBERNETES_TEMPLATE_FILE_NAME": "photon-3-kube-v1.23.8+vmware.1",
                        "UBUNTU_KUBERNETES_TEMPLATE_FILE_NAME": "ubuntu-2004-kube-v1.23.8+vmware.1",
                        "MARKETPLACE_KUBERNETES_SOLUTION_NAME": "tanzu-kubernetes-grid-1-1",
                        "MARKETPLACE_UBUNTU_KUBERNETES_FILE_NAME": "arcas-ubuntu-kube",
                        "MARKETPLACE_PHOTON_KUBERNETES_FILE_NAME": "arcas-photon-kube",
                        "MARKETPLACE_PHOTON_GROUPNAME": "Photon-OVA",
        ...
        if tkg_type == "tkgm":
            ...
            PHOTON_KUBERNETES_TEMPLATE_FILE_NAME = kubernetes_ova_dict[tkg_version]['PHOTON_KUBERNETES_TEMPLATE_FILE_NAME']
            UBUNTU_KUBERNETES_TEMPLATE_FILE_NAME = kubernetes_ova_dict[tkg_version]['UBUNTU_KUBERNETES_TEMPLATE_FILE_NAME']
            MARKETPLACE_KUBERNETES_SOLUTION_NAME = kubernetes_ova_dict[tkg_version]['MARKETPLACE_KUBERNETES_SOLUTION_NAME']
            MARKETPLACE_UBUNTU_KUBERNETES_FILE_NAME = kubernetes_ova_dict[tkg_version]['MARKETPLACE_UBUNTU_KUBERNETES_FILE_NAME']
            MARKETPLACE_PHOTON_KUBERNETES_FILE_NAME = kubernetes_ova_dict[tkg_version]['MARKETPLACE_PHOTON_KUBERNETES_FILE_NAME']
...
class Avi_Tkgs_Version:
    ...
    if tkg_type == "tkgs" and tkg_version not in TKGS_SUPPORTED_VERSIONS:
        raise f"TKGs Version is not in supported list"

    avi_version_dict = {"1.5": {"VSPHERE_AVI_VERSION": "20.1.7",
                                  "VMC_AVI_VERSION": "20.1.7",
                                  "AVI_VERSION_UPDATE_THREE": "20.1.7",
                                  "AVI_VERSION_UPDATE_TWO": "20.1.7"},
                        }
