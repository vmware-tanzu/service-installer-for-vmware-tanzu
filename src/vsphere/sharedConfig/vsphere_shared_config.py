...
from common.common_utilities import preChecks, envCheck, get_avi_version, checkSharedServiceProxyEnabled, \
    ...
    enable_data_protection_velero, checkDataProtectionEnabledVelero, checkAviL7EnabledForShared
            ...
            if not checkTmcEnabled(env):
                ...
                if checkTmcEnabled(env):
                    ...
                    register_payload = tmcBodyClusterCreation(management_cluster, provisoner, shared_cluster_name,
                                                              ...
                                                              shared_resource_path, osName, osVersion, "amd64",
                                                              templatePath, proxy_name, controlPlaneNodeCount)
