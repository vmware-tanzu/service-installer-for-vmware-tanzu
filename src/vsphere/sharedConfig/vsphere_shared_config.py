...
from common.operation.constants import SegmentsName,KubernetesOva, RegexPattern, Versions, AkoType, AppName, Extentions, Cloud
from requests.packages.urllib3.exceptions import InsecureRequestWarning
from vmc.sharedConfig.shared_config import deployExtentions
from common.common_utilities import preChecks, tmcBodyClusterCreation, envCheck, checkSharedServiceProxyEnabled, \
...
from common.common_utilities import preChecks, envCheck, get_avi_version, checkSharedServiceProxyEnabled, \
    ...
    enable_data_protection_velero, checkDataProtectionEnabledVelero, checkAviL7Enabled
        ...
        if not verifyPodsAreRunning(shared_cluster_name, command_status[0], RegexPattern.running):
            ...
            if not checkTmcEnabled(env):
                ...
                if checkTmcEnabled(env):
                    ...
                    register_payload = tmcBodyClusterCreation(management_cluster, provisoner, shared_cluster_name,
                                                              clusterGroup, pod_cidr, service_cidr, re,
                                                              vcenter_ip, cpu, disk, memory, machineCount, AkoType.SHARED_CLUSTER_SELECTOR,
                                                              version, datacenter_path, datastore_path,
                                                              shared_folder_path, shared_network_folder_path,
                                                              shared_resource_path, osName, osVersion, "amd64",templatePath,proxy_name)
