...
def configCloud():
    ...
    if get_se_cloud[0] == "NOT_FOUND":
        ...
        cloud_se = createSECloud(ip, csrf2, cloud_url, Cloud.SE_GROUP_NAME, aviVersion, "Mgmt")
...
def configTkgMgmt():
    ...
    listOfCmd = ["tanzu", "plugin", "install", "--group", "vmware-tkg/default:v2.3.0"]
    runProcess(listOfCmd)
...
def createSECloud(ip, csrf2, newCloudUrl, seGroupName, aviVersion, se_name_prefix):
    headers = {
        "Accept": "application/json",
        "Content-Type": "application/json",
        "Cookie": csrf2[1],
