locals {
  ...
  cse_server_configs = {
    ...
    ip_assignment = local.all_json_configs.envSpec.cseSpec.cseServerDeploySpec.ipAssignment
    ip_manual = local.all_json_configs.envSpec.cseSpec.cseServerDeploySpec.ip
