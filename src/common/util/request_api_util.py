...
class RequestApiUtil:
    ...
    @staticmethod
    def exec_req(req_type: str, api_url: str, headers: dict = None, data=None, params=None, verify=False, timeout=None):
        """
        ...
        try:
            response = requests.request(
                method=req_type, url=api_url, headers=headers, data=data, params=params, verify=verify, timeout=timeout
            )
            return response
    ...
    @staticmethod
    def create_json_object(message, response_type="SUCCESS", status_code=HTTPStatus.OK, add_data={}):
        """
