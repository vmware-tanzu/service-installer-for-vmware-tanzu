...
class Extentions:
    ...
    BOM_LOCATION_14 = "/root/.config/tanzu/tkg/bom/tkg-bom-v2.1.1.yaml"
...
class Tkgs_Extension_Details:
    ...
    PACKAGE_REPO_URL = "projects.registry.vmware.com/tkg/packages/standard/repo:v2.1.1"
...
class TKG_Package_Details:
    ...
    REPOSITORY_URL = "projects.registry.vmware.com/tkg/packages/standard/repo:v2.1.1"
