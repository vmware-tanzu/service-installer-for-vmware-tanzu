...
class Extension:
    ...
    BOM_LOCATION_14 = "/root/.config/tanzu/tkg/bom/tkg-bom-v2.3.0.yaml"
...
class TKG_Package_Details:
    ...
    REPOSITORY_URL = "projects.registry.vmware.com/tkg/packages/standard/repo:v2023.7.13"
