...
class KubernetesOva:
    ...
    UBUNTU_KUBERNETES__TEMPLATE_FILE_NAME = "ubuntu-2004-kube-v1.24.9+vmware.1"
...
class Extentions:
    ...
    BOM_LOCATION_14 = "/root/.config/tanzu/tkg/bom/tkg-bom-v2.1.0.yaml"
...
class Tkgs_Extension_Details:
    ...
    SUPPORTED_VERSIONS_U3 = ["v1.20.7+vmware.1-tkg.1.7fb9067", "v1.20.9+vmware.1-tkg.1.a4cee5b",
...
class TKG_Package_Details:
    ...
    REPOSITORY_URL = "projects.registry.vmware.com/tkg/packages/standard/repo:v2.1.0"
...
class VcdCSE:
    ...
    CLI_WARNING_MSG = "InsecureRequestWarning: Unverified HTTPS request is being made. " \
