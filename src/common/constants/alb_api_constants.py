...
class AlbEndpoint:
    ...
    GENERATE_SE_OVA = BASE_URL + "/api/fileservice/seova"
    DOWNLOAD_SE_OVA = BASE_URL + "/api/fileservice/seova?file_format=ova&cloud_uuid={uuid}"
    GENERATE_TOKEN = "/api/securetoken-generate?cloud_uuid={uuid}"
    ...
    NSXT_TIER = BASE_URL + "/api/nsxt/tier1s"
