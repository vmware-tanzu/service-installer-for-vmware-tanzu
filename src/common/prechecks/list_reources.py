...
from common.prechecks.precheck import checkClusterNamespace, get_cluster, getClusterVersionsFullList, getNetwork
...
def validateKubeVersion(env, cluster):
    ...
    if response[1] == 200:
        ...
        current_app.logger.info("Invalid KubeVersion for " + cluster + " cluster.")
        d = {"responseType": "ERROR", "msg": "Invalid KubeVersion for " + cluster + " cluster.", "STATUS_CODE": 500}
        return jsonify(d), 500
