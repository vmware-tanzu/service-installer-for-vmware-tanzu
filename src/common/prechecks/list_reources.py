...
from common.common_utilities import (
    ...
    validate_cluster_credential,
)
from common.lib.vcenter.vcenter_ssl_operations import VCenterSSLOperations
from common.operation.constants import Env, MarketPlaceUrl, TmcUser, VeleroAPI
...
def getSupervisorClusterHealth():
    try:
        ...
        state = SaaSUtil.check_cluster_state_on_tmc(super_cluster, True)
        if state[0] == "SUCCESS":
