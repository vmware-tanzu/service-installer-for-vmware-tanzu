...
template="tanzu-cloud-formation-iamtemplate.yaml"
# cloud formation template for tmc needed permission for cluster nodes
if [[ "$TMC_API_TOKEN" != "" ]]; then
    # download TMC
    template="tanzu-tmc-cloud-formation-iamtemplate.yaml"
else
    template="tanzu-cloud-formation-iamtemplate.yaml"
fi
