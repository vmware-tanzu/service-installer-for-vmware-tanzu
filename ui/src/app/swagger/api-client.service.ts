...
export class APIClient {
    ...
    public baseImageVersion = ['v1.27.5', 'v1.26.8', 'v1.25.13'];
    public AllSupportedCNI = ['antrea', 'calico'];
    public allowedWorkerVolumeNames = ["kubelet", "containerd"];

    public clusterKinds = ['TanzuKubernetesCluster', 'ClusterClass'];
    public vcenterVersion = '';
    public jsonFileHomePath = '/home';
...
//     public storageSpec = [];
    ...
    public clusterVersionsBeta = [];
    public clusterVersionsAlpha = [];
    ...
    public vdsWCPJSONFileName = 'vsphere-dvs-tkgs-wcp.json';
    public vdsNameSpaceJSONFileName = 'vsphere-dvs-tkgs-namespace.json';
    ...
    //Global variable deployment Status
    ...
    getVcenterVersion(vCenterData) {
        ...
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url =  base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.VCENTER_VERSION;
        return this.apiHandlerService.postCall(url, payload, 'vsphere');
    }
    ...
    getSupervisorClustersForTMC(refreshToken, tmcInstanceURL) {
        let payload = {
            "saasEndpoints": {
                "tmcDetails": {
                    "tmcRefreshToken": refreshToken,
                    "tmcInstanceURL": tmcInstanceURL,
                }
            }
        };
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
    ...
    validateSupervisorCluster(clusterName, tmcInstanceURL, tmcRefreshToken) {
        let payload = {
            'envSpec': {
                'saasEndpoints': {
                    'tmcDetails': {
                        ...
                        'tmcInstanceURL': tmcInstanceURL,
                        'tmcRefreshToken': tmcRefreshToken
                    }
                }
            }
        };
    ...
    triggerPrecheck(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.PRECHECKS;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggerAvi(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;

        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.AVI_CONFIG;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggerAviWCP(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.VSPHERE_TRIGGER_AVI_WCP;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggerWCPEnablement(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.VSPHERE_TRIGGER_WCP;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggerSupervisorNamespaceCreation(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.VSPHERE_CREATE_SUPERVISOR_NAMESPACE;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggeWorkloadClusterCreation(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.VSPHERE_CREATE_WORKLOAD_CLUSTER;
        return this.apiHandlerService.postCall(url, payload, env);
    }

    triggerVmcAvi(env: string, payload: any) {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        if (env === 'vmc') {
    ...
    deployStatusDetails() {
        const baseUrl = this.apiEndPoint  + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = baseUrl + AppApiUrls.URL_SEPARATER + AppApiUrls.DEPLOY_DETAIL_STATUS;
        return this.apiHandlerService.get(url);
    }

    deployStatusOverview() {
        const baseUrl = this.apiEndPoint  + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = baseUrl + AppApiUrls.URL_SEPARATER + AppApiUrls.DEPLOY_DETAIL_OVERVIEW;
        return this.apiHandlerService.get(url);
    }
    ...
    downloadLogFile(env){
        const baseUrl = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = baseUrl + AppApiUrls.URL_SEPARATER + AppApiUrls.DOWNLOAD_LOGS;
        return this.apiHandlerService.download(url, env);
    }
    ...
    loginToSIVT(fqdn: string, username: string, password: string) {
        let payload = {
            "fqdn": fqdn,
            "username": username,
            "password": password
        ...
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.LOGIN_TO_SIVT;
        return this.apiHandlerService.loginAPIpost(url, payload);
    }

    logoutOfSivt() {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.LOGOUT_OF_SIVT;
        return this.apiHandlerService.get(url);
    }

    isSessionActive() {
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.ACTIVE_SESSION;
        return this.apiHandlerService.get(url);
    }

    streamingService(controller: { signal: any; }): Promise<any>{
        let requestHeaders = { 'x-access-tokens': localStorage.getItem('token') } as unknown as Headers;
        const base_url = this.apiEndPoint + AppApiUrls.URL_SEPARATER + AppApiUrls.BASE_URL;
        const url = base_url + AppApiUrls.URL_SEPARATER + AppApiUrls.ARCAS_LOGS;
        return fetch(url, {
        allowHTTP1ForStreamingUpload: true, signal: controller.signal, headers: requestHeaders,
        } as any);
    }
