...
export  class VsphereNsxtDataService {
    ...
    // AVI HA fields
    private enableL7 = new BehaviorSubject<boolean>(false);
    ...
    // AVI Components
    currentAviL7 = this.enableL7.asObservable();
    ...
    changeEnableAviL7(enableL7: boolean) {
        this.enableL7.next(enableL7);
    }
