...
export  class VsphereTkgsService {
    ...
    private clusterKind = new BehaviorSubject('TanzuKubernetesCluster');
    ...
    currentClusterKind = this.clusterKind.asObservable();
    ...
    changeClusterKind(kind: string){
        this.clusterKind.next(kind);
    }
