...
export  class DataService {
    ...
    private modeOfDeployment = new BehaviorSubject('orchestrated');
    private typeOfLicense = new BehaviorSubject('enterprise');
    ...
    private compliantDeployment = new BehaviorSubject<boolean>(false);
    // VELERO FIELDS
    ...
    private enableL7Shared = new BehaviorSubject<boolean>(false);
    ...
    private enableL7Workload = new BehaviorSubject<boolean>(false);
    ...
    currentModeOfDeployment = this.modeOfDeployment.asObservable();
    currentTypeOfLicense = this.typeOfLicense.asObservable();
    ...
    // Compliance airgap deployment fields
    currentCompliantDeployment = this.compliantDeployment.asObservable();
    // VELERO FIELDS
    ...
    currentAviL7Shared = this.enableL7Shared.asObservable();
    // VELERO via TMC FIELDS
    ...
    currentAviL7Workload = this.enableL7Workload.asObservable();
    ...
    changeModeOfDeployment(mode: string) {
        this.modeOfDeployment.next(mode);
    }
    changeTypeOfLicense(mode: string) {
        this.typeOfLicense.next(mode);
    }
    ...
    changeCompliantDeployment(isCompliant: boolean) {
        this.compliantDeployment.next(isCompliant);
    }
    // VELERO FIELDS
    ...
    changeEnableAviL7Shared(enableL7: boolean) {
        this.enableL7Shared.next(enableL7);
    }
    ...
    changeEnableAviL7Workload(enableL7: boolean) {
        this.enableL7Workload.next(enableL7);
    }
}
