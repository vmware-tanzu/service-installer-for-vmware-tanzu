...
export enum AppApiUrls {
    ...
    VCENTER_VERSION = 'getVcenterVersion',
    ...
    /////////////////////////// vSphere VDS Deployment Endpoint //////////////////////////////
    PRECHECKS = 'precheck',
    AVI_CONFIG = 'vsphere/alb',
    VSPHERE_TRIGGER_AVI_WCP = 'vsphere/tkgmgmt/alb/config/wcp',
    VSPHERE_TRIGGER_WCP = 'vsphere/enablewcp',
    VSPHERE_CREATE_SUPERVISOR_NAMESPACE = 'vsphere/workload/createnamespace',
    VSPHERE_CREATE_WORKLOAD_CLUSTER = 'vsphere/workload/createworkload',
    ...
    VCF_VSPHERE_VMC_TRIGGER_EXTENSIONS = 'extensions',
    ...
    /////////////////////////////// DEPLOY STATUS //////////////////////////////
    DEPLOY_DETAIL_STATUS = 'deployStatusDetails',
    DEPLOY_DETAIL_OVERVIEW = 'deployStatusOverview',
    ////////////////////////////////// Logs /////////////////////////////////////////////
    ...
    ///////////////////////////////// VCD ///////////////////////////////////////////////
    CONNECT_TO_VCD = 'getVCDConnection',
    LIST_NSXT_CLOUD_VCD_DISPLAY_NAMES = 'listCloudVcd',
    LIST_AVI_VCD_DISPLAY_NAMES = 'listAviVcd',
    LIST_AVI_NSX_CLOUD_NAMES = 'listNSXTCloud',
    LIST_T0_ROUTERS_FROM_NSXT = 'listTier0Nsx',
    LIST_T0_ROUTERS_FROM_VCD = 'listTier0Vcd',
    FETCH_IP_RANGES_FOR_T0 = 'getIpRangesForT0Gateway',
    LIST_SVC_ORG_NAMES = 'listOrgVcd',
    VALIDATE_ORG_PUBLISH_STATUS = 'validateOrgVcd',
    LIST_PROVIDER_VDC_NAMES = 'listProviderVDC',
    LIST_NETWORK_POOL_NAMES = 'listNetworkPoolsVcd',
    LIST_STORAGE_POLICIES = 'listStoragePolicyVcd',
    LIST_SEG_NAMES_FROM_ALB = 'getSegAvi',
    LIST_SEG_NAMES_FROM_VCD = 'listSegVcd',
    LIST_CATALOGS = 'listCatalogVcd',
}
