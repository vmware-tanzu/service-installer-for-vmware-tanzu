        ...
        if (input) {
            ...
            if (input.hasOwnProperty('componentSpec')) {
                if (input['componentSpec'].hasOwnProperty('aviComponentSpec')) {
                    ...
                    if (input['componentSpec']['aviComponentSpec'].hasOwnProperty('enableAviL7')) {
                        if(input['componentSpec']['aviComponentSpec']['enableAviL7'] === 'true') {
                            this.vmcDataService.changeEnableAviL7(true);
                        } else {
                            this.vmcDataService.changeEnableAviL7(false);
                        }
                    } else {
                        this.vmcDataService.changeEnableAviL7(false);
                    }
