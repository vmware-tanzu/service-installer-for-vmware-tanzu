...
describe('VCDWizardComponent', () => {
    let component: VCDWizardComponent;
    let fixture: ComponentFixture<VCDWizardComponent>;
        ...
        TestBed.configureTestingModule({
            imports: [
                ...
                RouterTestingModule.withRoutes([
                    { path: 'upload', component: VCDWizardComponent },
                ]),
                SharedModule,
            ],
            providers: [
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(VCDWizardComponent);
