...
//                 (mgmt) => this.mgmtCluster = mgmt);
    ...
    toggleTanzuExtension() {
        ...
        if (this.formGroup.get('tanzuExtensions').value && !this.apiClient.toEnabled) {
    ...
    setLoggingEndpoint() {
        ...
        if (this.formGroup.get('loggingEndpoint').value === 'Syslog') {
            ...
            this.resurrectField('httpEndpointUri', [
                Validators.required, this.validationService.isHttpOrHttps(), this.validationService.noWhitespaceOnEnds()],
