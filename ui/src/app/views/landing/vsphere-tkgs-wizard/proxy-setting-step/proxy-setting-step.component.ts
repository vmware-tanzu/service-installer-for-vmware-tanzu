 ...
 */
 ...
 import {VsphereTkgsService} from '../../../../shared/service/vsphere-tkgs-data.service';
  ...
  @Component({
     selector: 'app-proxy-step',
     templateUrl: './proxy-setting-step.component.html',
     styleUrls: ['./proxy-setting-step.component.scss']
  })
  export class ProxySettingStepComponent extends StepFormDirective implements OnInit {
