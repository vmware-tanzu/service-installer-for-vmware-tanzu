...
describe('VSphereTkgsWizardComponent', () => {
    let component: VSphereTkgsWizardComponent;
    let fixture: ComponentFixture<VSphereTkgsWizardComponent>;
        ...
        TestBed.configureTestingModule({
            imports: [
                ...
                RouterTestingModule.withRoutes([
                    { path: 'upload', component: VSphereTkgsWizardComponent },
                ]),
                SharedModule,
            ],
            providers: [
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(VSphereTkgsWizardComponent);
