...
const SupervisedField = ['refreshToken'];
...
export class TanzuSaasStepComponent extends StepFormDirective implements OnInit {
    ...
    ngOnInit() {
        ...
        this.formGroup.addControl('refreshToken', new FormControl('', [this.validationService.noWhitespaceOnEnds()]));
        this.formGroup.addControl('toSettings', new FormControl(false));
        this.formGroup.addControl('toUrl', new FormControl('', [this.validationService.noWhitespaceOnEnds()]));
        this.formGroup.addControl('toRefreshToken', new FormControl('', [this.validationService.noWhitespaceOnEnds()]));
