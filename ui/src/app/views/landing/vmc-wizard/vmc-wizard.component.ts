...
//                     'aviLicenseKey': this.getFieldValue('vmcAVINetworkSettingForm', 'aviLicenseKey'),
            ...
            'tanzuExtensions': {
                'enableExtensions': !this.apiClient.toEnabled ? this.getStringBoolFieldValue('vmcExtensionSettingForm', 'tanzuExtensions') : "false",
                'tkgClustersName': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'tanzuExtensionClusters') : "",
                'logging': {
                    'syslogEndpoint': {
                        'enableSyslogEndpoint': !this.apiClient.toEnabled ? this.enableLoggingExtension('Syslog') : "false",
                        'syslogEndpointAddress': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'syslogEndpointAddress') : "",
                        'syslogEndpointPort': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'syslogEndpointPort') : "",
                        'syslogEndpointMode': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'syslogEndpointMode') : "",
                        'syslogEndpointFormat': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'syslogEndpointFormat') : "",
                    },
                    'httpEndpoint': {
                        'enableHttpEndpoint': !this.apiClient.toEnabled ? this.enableLoggingExtension('HTTP') : "false",
                        'httpEndpointAddress': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'httpEndpointAddress') : "",
                        'httpEndpointPort': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'httpEndpointPort') : "",
                        'httpEndpointUri': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'httpEndpointUri') : "",
                        'httpEndpointHeaderKeyValue': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'httpEndpointHeaderKeyValue') : "",
                    },
                    ...
                    'kafkaEndpoint': {
                        ...
                        'kafkaBrokerServiceName': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'kafkaBrokerServiceName') : "",
                        'kafkaTopicName': !this.apiClient.toEnabled ? this.getFieldValue('vmcExtensionSettingForm', 'kafkaTopicName') : "",
                    },
                    'splunkEndpoint': {
