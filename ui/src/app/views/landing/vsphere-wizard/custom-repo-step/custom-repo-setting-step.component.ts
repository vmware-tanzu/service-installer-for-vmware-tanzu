...
//     public airgapped: boolean = false;
...
//             this.dataService.currentIsAirgapped.subscribe(
//                 (airgap) => this.airgapped = airgap);
//             if (this.airgapped) {
//                 this.formGroup.get('customRepoSetting').setValue(true);
//                 this.toggleCustomRepoSetting();
//                 this.formGroup.get('customRepoSetting').disable();
//             }
        });
    }
