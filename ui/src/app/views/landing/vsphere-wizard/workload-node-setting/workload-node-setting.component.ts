...
//         );
        ...
        this.formGroup.addControl('clusterCidr', new FormControl('100.96.0.0/11', [
            // Validators.required,
            // this.validationService.isValidIpNetworkSegment(),
            // this.validationService.noWhitespaceOnEnds()
        ]));
        this.formGroup.addControl('serviceCidr', new FormControl('100.64.0.0/13', [
            // Validators.required,
            // this.validationService.isValidIpNetworkSegment(),
            // this.validationService.noWhitespaceOnEnds()
        ]));
        this.formGroup.addControl('baseImage', new FormControl('', [
            // Validators.required
        ]));
        this.formGroup.addControl('baseImageVersion', new FormControl('', [
            // Validators.required
        ]));
        ...
        this.formGroup.addControl('wrkCpu', new FormControl('', [
            // Validators.min(2)
        ]));
        this.formGroup.addControl('wrkMemory', new FormControl('', [
            // Validators.min(4)
        ]));
        this.formGroup.addControl('wrkStorage', new FormControl('', [
            // Validators.min(20)
        ]));
        ...
        this.formGroup.addControl('clusterAdminUsers', new FormControl('', [
            // this.validationService.noWhitespaceOnEnds()
        ]));
        this.formGroup.addControl('adminUsers', new FormControl('', [
            // this.validationService.noWhitespaceOnEnds()
        ]));
        this.formGroup.addControl('editUsers', new FormControl('', [
            // this.validationService.noWhitespaceOnEnds()
        ]));
        this.formGroup.addControl('viewUsers', new FormControl('', [
            // this.validationService.noWhitespaceOnEnds()
        ]));
