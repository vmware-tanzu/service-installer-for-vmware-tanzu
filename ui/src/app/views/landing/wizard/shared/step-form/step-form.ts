...
import { ValidatorEnum } from 'src/app/views/landing/wizard/shared/constants/validation.constants';
...
export abstract class StepFormDirective extends BasicSubscriber implements OnInit {
    ...
    // Fields to set Arcas Proxy here
    arcasProxySettings: boolean;
    arcasHttpProxyUrl: string;
    arcasHttpUsername: string;
    arcasHttpPassword: string;
    arcasIsSameAsHttp: boolean;
    arcasHttpsProxyUrl: string;
    ...
    setArcasProxySettings(proxySettings, httpUrl, httpUsername, httpPassword, isSameAsHttp,
                          httpsUrl, httpsUsername, httpsPassword, noProxy) {
        this.arcasProxySettings = proxySettings;
        this.arcasHttpProxyUrl = httpUrl;
        this.arcasHttpUsername = httpUsername;
        this.arcasHttpPassword = httpPassword;
        this.arcasIsSameAsHttp = isSameAsHttp;
        this.arcasHttpsProxyUrl = httpsUrl;
        this.arcasHttpsUsername = httpsUsername;
        this.arcasHttpsPassword = httpsPassword;
        this.arcasNoProxy = noProxy;
    }
