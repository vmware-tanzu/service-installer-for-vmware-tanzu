    ...
    onMgmtNextClick() {
        if (this.uploadStatus) {
            ...
            if(this.apiClient.compliantDeployment) {
                ...
                this.form.get('vsphereWorkloadNodeSettingForm').get('baseImageVersion').setValue('v1.26.5');
                this.form.get('vsphereSharedServiceNodeSettingForm').get('baseImageVersion').setValue('v1.26.5');
            }
        }
        this.onNextStep();
    }
