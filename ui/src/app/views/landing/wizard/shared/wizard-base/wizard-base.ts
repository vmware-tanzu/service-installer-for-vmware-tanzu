...
//         }
    ...
    onMgmtNextClick() {
        ...
        if(this.apiClient.compliantDeployment) {
            ...
            this.form.get('vsphereWorkloadNodeSettingForm').get('baseImageVersion').setValue('v1.23.8');
            this.form.get('vsphereSharedServiceNodeSettingForm').get('baseImageVersion').setValue('v1.23.8');
        }
        this.onNextStep();
    }
