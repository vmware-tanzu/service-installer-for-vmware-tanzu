...
//         }
    ...
    onMgmtNextClick() {
        ...
        if(this.apiClient.compliantDeployment) {
            ...
            this.form.get('vsphereWorkloadNodeSettingForm').get('baseImageVersion').setValue('v1.24.9');
            this.form.get('vsphereSharedServiceNodeSettingForm').get('baseImageVersion').setValue('v1.24.9');
        }
        this.onNextStep();
    }
