...
export abstract class WizardBaseDirective extends BasicSubscriber implements AfterViewInit, OnInit {
    ...
    // nsxtSteps = [true, false, false, false, false, false, false, false, false, false, false];
...
//         this.dataService.changeIsAirgapped(this.getBooleanFieldValue('vsphereProviderForm', 'airgapped'));
    ...
    onCustomRepoNextClick() {
        ...
        if(!this.uploadStatus && this.apiClient.isAirgapped) {
            ...
            this.form.get('vsphereMgmtNodeSettingForm').get('compliantDeployment').setValue(true);
        }
        this.onNextStep();
    }
...
//         }
    ...
    onMgmtNextClick() {
        ...
        if(this.apiClient.compliantDeployment) {
            ...
            this.form.get('vsphereWorkloadNodeSettingForm').get('baseImageVersion').setValue('v1.24.10');
            this.form.get('vsphereSharedServiceNodeSettingForm').get('baseImageVersion').setValue('v1.24.10');
        }
        this.onNextStep();
    }
