...
//                         'ldapTestGroupName': this.getFieldValue('IdentityMgmtForm', 'testGroupName'),
            ...
            'tkgWorkloadComponents': {
                ...
                'tkgWorkloadGatewayCidr': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'gatewayAddress'),
                'tkgWorkloadDhcpStartRange': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'DhcpStartRange'),
                'tkgWorkloadDhcpEndRange': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'DhcpEndRange'),
                ...
                'tkgWorkloadRbacUserRoleSpec': {
                    'clusterAdminUsers': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'clusterAdminUsers'),
                    'adminUsers': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'adminUsers'),
                    'editUsers': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'editUsers'),
                    'viewUsers': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'viewUsers'),
                },
                ...
                'tkgWorkloadClusterGroupName': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'clusterGroupName'),
                'tkgWorkloadEnableDataProtection': this.getStringBoolFieldValue('vsphereWorkloadNodeSettingForm', 'enableDataProtection'),
                'tkgWorkloadClusterCredential': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'veleroCredential'),
                'tkgWorkloadClusterBackupLocation': this.getFieldValue('vsphereWorkloadNodeSettingForm', 'veleroTargetLocation'),
            },
            'harborSpec': {
