...
//                             }
            ...
            if (input.hasOwnProperty('tkgComponentSpec')) {
                if (input['tkgComponentSpec'].hasOwnProperty('aviComponents')) {
                    ...
                    if (input['tkgComponentSpec']['aviComponents'].hasOwnProperty('enableAviL7')) {
                        if(input['tkgComponentSpec']['aviComponents']['enableAviL7'] === 'true') {
                            this.nsxtDataService.changeEnableAviL7(true);
                        } else {
                            this.nsxtDataService.changeEnableAviL7(false);
                        }
                    } else {
                        this.nsxtDataService.changeEnableAviL7(false);
                    }
