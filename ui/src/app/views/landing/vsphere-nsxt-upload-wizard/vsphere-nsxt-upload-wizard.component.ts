...
//     edition: string;
    ...
    public setVmcParamsFromInputJSON(input) {
        if (input) {
            ...
            // input['saasEndpoints']['tanzuObservabilityDetails']['tanzuObservabilityAvailability'] = 'false';
        ...
        if (input) {
            ...
            if (input.hasOwnProperty('envSpec')) {
                ...
                if (input['envSpec'].hasOwnProperty('vcenterDetails')) {
                    ...
                    if(input['envSpec']['vcenterDetails'].hasOwnProperty('modeOfDeployment')) {
                        let mode = input['envSpec']['vcenterDetails']['modeOfDeployment'];
                        if(mode.toLowerCase() === 'non-orchestrated') this.dataService.changeModeOfDeployment('non-orchestrated');
                        else this.nsxtDataService.changeModeOfDeployment('orchestrated');
                    } else {
                        this.nsxtDataService.changeModeOfDeployment('orchestrated');
                    }
                ...
                if (input['envSpec'].hasOwnProperty('compliantSpec')) {
                    if (input['envSpec']['compliantSpec'].hasOwnProperty('compliantDeployment')) {
                        ...
                        if(input['envSpec']['compliantSpec']['compliantDeployment'] === 'true') {
                            this.nsxtDataService.changeCompliantDeployment(true);
                        } else this.nsxtDataService.changeCompliantDeployment(false);
                    } else this.nsxtDataService.changeCompliantDeployment(false);
                } else this.nsxtDataService.changeCompliantDeployment(false);
...
//                     }
                ...
                if (input['tkgComponentSpec'].hasOwnProperty('tkgSharedserviceSpec')) {
                    ...
                    if (input['tkgComponentSpec']['tkgSharedserviceSpec'].hasOwnProperty('tkgSharedserviceEnableAviL7')) {
                        if(input['tkgComponentSpec']['tkgSharedserviceSpec']['tkgSharedserviceEnableAviL7'] === 'true') {
                            this.nsxtDataService.changeEnableAviL7Shared(true);
                        } else this.nsxtDataService.changeEnableAviL7Shared(false);
                    } else this.nsxtDataService.changeEnableAviL7Shared(false);
            ...
            if (input.hasOwnProperty('tkgWorkloadComponents')) {
                ...
                if (input['tkgWorkloadComponents'].hasOwnProperty('tkgWorkloadEnableAviL7')) {
                    if(input['tkgWorkloadComponents']['tkgWorkloadEnableAviL7'] === 'true') {
                        this.nsxtDataService.changeEnableAviL7Workload(true);
                    } else this.nsxtDataService.changeEnableAviL7Workload(false);
                } else this.nsxtDataService.changeEnableAviL7Workload(false);
