...
export class ServiceOrganizationVDCComponent extends StepFormDirective implements OnInit {
    ...
    ngOnInit() {
        ...
        this.formGroup.addControl('vcpuSpeed', new FormControl('1', [Validators.required]));
        this.formGroup.addControl('vmQuota', new FormControl('100', [Validators.required]));
        ...
        this.formGroup.addControl('networkQuota', new FormControl('100', [Validators.required]));
