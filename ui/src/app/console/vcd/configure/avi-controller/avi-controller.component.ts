...
import { aviSize, NodeType } from 'src/app/views/landing/wizard/shared/constants/wizard.constants';
...
export class AviControllerComponent extends StepFormDirective implements OnInit {
    ...
    ngOnInit() {
        ...
        // VSPHERE
        this.formGroup.addControl('vcenterAddress', new FormControl('', []));
        this.formGroup.addControl('vcenterSsoUser', new FormControl('', []));
        this.formGroup.addControl('vcenterSsoPasswordBase64', new FormControl('', []));
        ...
        this.formGroup.addControl('contentLibraryName', new FormControl('', []));  // Optional if marketplace is enabled
        this.formGroup.addControl('aviOvaName', new FormControl('', []));  // Optional if marketplace is enabled
        this.formGroup.addControl('thumbprint', new FormControl('', [])); // Fetched from Backend, no use on UI

        //AVI MANAGEMENT NETWORK
        this.formGroup.addControl('aviMgmtNetworkName', new FormControl('', []));
        this.formGroup.addControl('aviMgmtNetworkGatewayCidr', new FormControl('', []));
        ...
        this.formGroup.addControl('aviBackupPassphraseBase64', new FormControl('', []));
        this.formGroup.addControl('enableAviHa', new FormControl(false, []));
        this.formGroup.addControl('aviController01Ip', new FormControl('', []));
        this.formGroup.addControl('aviController01Fqdn', new FormControl('', []));
        this.formGroup.addControl('aviController02Ip', new FormControl('', []));
        this.formGroup.addControl('aviController02Fqdn', new FormControl('', []));
        this.formGroup.addControl('aviController03Ip', new FormControl('', []));
        this.formGroup.addControl('aviController03Fqdn', new FormControl('', []));
        ...
        this.formGroup.addControl('aviSize', new FormControl('', []));
        this.formGroup.addControl('aviCertPath', new FormControl('', []));
        this.formGroup.addControl('aviCertKeyPath', new FormControl('', []));
