    ...
    public getPayload() {
        const payload = {
            'envSpec': {
                'envType': 'vcd-avi',
                'marketplaceSpec' : {
                    'refreshToken': this.getFieldValue('aviControllerForm', 'marketplaceRefreshToken'),
                },
                ...
                'cseSpec': {
                    ...
                    'svcOrgVdcSpec': {
                        ...
                        'svcOrgVdcResourceSpec': {
                            ...
                            'cpuAllocation': this.getFieldValue('svcOrgVdcForm', 'cpuAllocation').toString(),
                            'cpuGuaranteed': this.getFieldValue('svcOrgVdcForm', 'cpuGuaranteed').toString() === '' ? '20' : this.getFieldValue('svcOrgVdcForm', 'cpuGuaranteed').toString(),
                            'memoryAllocation': this.getFieldValue('svcOrgVdcForm', 'memoryAllocation').toString(),
                            'memoryGuaranteed': this.getFieldValue('svcOrgVdcForm', 'memoryGuaranteed').toString() === '' ? '20' : this.getFieldValue('svcOrgVdcForm', 'memoryGuaranteed').toString(),
                            'vcpuSpeed': this.getFieldValue('svcOrgVdcForm', 'vcpuSpeed').toString() === '' ? '1' : this.getFieldValue('svcOrgVdcForm', 'vcpuSpeed').toString(),
                            'vmQuota': this.getFieldValue('svcOrgVdcForm', 'vmQuota').toString() === '' ? '100' : this.getFieldValue('svcOrgVdcForm', 'vmQuota').toString(),
                            'networkPoolName': this.getFieldValue('svcOrgVdcForm', 'networkPoolName'),
                            'networkQuota': this.getFieldValue('svcOrgVdcForm', 'networkQuota').toString() === '' ? '100' : this.getFieldValue('svcOrgVdcForm', 'networkQuota').toString(),
                            'storagePolicySpec': {
                    ...
                    'cseServerDeploySpec': {
                        ...
                        'ipAssignment': this.getFieldValue('vappForm', 'ipAssignment'),
                        'ip': this.getFieldValue('vappForm', 'ip'),
                        'customCseProperties': {
