...
import { SharedModule } from 'src/app/views/landing/../../shared/shared.module';
import { ReactiveFormsModule } from '@angular/forms';
import { FormBuilder } from '@angular/forms';
import { TKGSGlobalConfig } from 'src/app/console/vds-tkgs/configure/tkgs-global-config/tkgs-gloal-config.component';
