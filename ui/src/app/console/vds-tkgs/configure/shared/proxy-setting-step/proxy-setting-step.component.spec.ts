...
import { ProxySettingStepComponent } from 'src/app/console/vds-tkgs/configure/proxy-setting-step/proxy-setting-step.component';
import Broker from 'src/app/shared/service/broker';
import { Messenger } from 'src/app/shared/service/Messenger';

describe('ProxySettingStepComponent', () => {
    let component: ProxySettingStepComponent;
    let fixture: ComponentFixture<ProxySettingStepComponent>;
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [ProxySettingStepComponent],
        })
            .compileComponents();
    }));
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(ProxySettingStepComponent);
