...
@Component({
    selector: 'app-upload',
    templateUrl: './vsphere-tkgs-upload-wizard.component.html',
    styleUrls: ['./vsphere-tkgs-upload-wizard.component.scss'],
})
export class VsphereTkgsUploadWizardComponent implements OnInit {
        ...
        if (input) {
            ...
            if (input.hasOwnProperty('tkgsComponentSpec')) {
                ...
                if (input['tkgsComponentSpec'].hasOwnProperty('tkgsVsphereNamespaceSpec')) {
                    ...
                    if (input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec'].hasOwnProperty('tkgsVsphereNamespaceVmClasses')) {
                        if (input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec']['tkgsVsphereNamespaceVmClasses'].length === 0) {
                            this.vsphereTkgsDataService.changeNamespaceVmClass("")
                        } else {
                        this.vsphereTkgsDataService.changeNamespaceVmClass(
                            input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec']['tkgsVsphereNamespaceVmClasses']);
                    ...
                    if (input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec'].hasOwnProperty('tkgsVsphereWorkloadClusterSpec')) {
                        ...
                        if (input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec']['tkgsVsphereWorkloadClusterSpec'].hasOwnProperty('tkgsVsphereWorkloadClusterKind')) {
                            this.vsphereTkgsDataService.changeClusterKind(
                                input['tkgsComponentSpec']['tkgsVsphereNamespaceSpec']['tkgsVsphereWorkloadClusterSpec']['tkgsVsphereWorkloadClusterKind']);
                        }
